...
app = FastAPI(
    title="GIF Sender telegram bot",
    description="GIF Sender telegram bot",
    version="0.0.1",
    docs_url="/api/docs",
)
...
async def on_startup():
    ...
    # Below import is required because handlers for messages and commands has to be loaded.
    # Otherwise, sending messages/commands will result in nothing.
